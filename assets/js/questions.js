...
{
    question: "What was the name of the monitor on the Genesis in Halo 5",
    answers: [
        {text: "Exuberant Witness"},
        {text: "343 Guilty spark"},
        {text: "859 Static Carillon"},
        {text: "2401 Penitent Tangent's"}
    ],
    correctAnswer: "Exuberant Witness"
},
{
...
const hardQuestions = [{
    question: "What is the homeworld of the Hunter",
    answers: [
        {text: "Lekgolo"},
        {text: "Te"},
        {text: "Hreginus"},
...
{
    question: "What episode name out of the 4 below is a real episode name for Halo Legends?",
    answers: [
        {text: "Origins Part 3"},
        {text: "The Duel Part 2"},
        {text: "The experiment"},
        {text: "The Babysitter"}
    ],
...
{
    question: "Halo Legends which legendary spartan said the famous line “That sounds like one heck of a mama. And you know what? I'm one heck of a mama myself!",
    answers: [
        {text: "Spartan 1426"},
        {text: "Spartan 1348"},
        {text: "Spartan 1337"},
    ...
    correctAnswer: "Spartan 1337"
},
{
    question: "In Halo Legends what is the name of the protype suit from the episode of the same name",
    answers: [
        {text: "Mantis"},
        {text: "HRUNTING/YGGDRASIL Mark I Prototype Armor Defense System"},
        {text: "Scarab"},
        {text: "Cyclops"}
    ],
    correctAnswer: "HRUNTING/YGGDRASIL Mark I Prototype Armor Defense System"
},
{
    question: " In Halo Legends the Package who does the Master Chief fight",
    answers: [
        {text: "Rtas 'Vadum"},
        {text: "Thel 'Vadam"},
        {text: "Jul 'Mdama's"},
    ...
    correctAnswer: "Thel 'Lodamee"
},
{
    question: "What kills Spartan Daisy-023",
    answers: [
        {text: "Needler rounds"},
        {text: "Fuel Road shot"},
        {text: "Energy Sword"},
        {text: "Plasma Pistol shot"}
    ],
    correctAnswer: "Needler rounds"
},
{
    question: "What does Daisy-023 discover at her former home",
    answers: [
        {text: "Yap Yap"},
        {text: "A flash clone"},
        {text: "Dr. Catherine Halsey"},
        {text: "The Master Chief"}
    ],
    correctAnswer: "A flash clone"
},
{
    question: "What is the weird easter egg found in Halo 3 on the level Sierra 117",
    answers: [
        {text: "Grunt have an existential crisis"},
        {text: "Thel 'Vadam asking if Chief loves him"},
        {text: "A monkey family"},
        {text: "Atriox hosting a tea party"}
    ],
    correctAnswer: "A monkey family"
},
{
    question: "Who imprisoned the Didact",
    answers: [
        {text: "Mendicant Bias"},
        {text: "Cortana"},
        {text: "343 Guilty Spark"},
    ...
    correctAnswer: "The Librarian"
},
{
    question: "What are Promethean Knights made from",
    answers: [
        {text: "Ancient Humans"},
        {text: "Sangheili"},
        {text: "Unggoy"},
    ...
    correctAnswer: "Ancient Humans"
},
{
    question: "What is the Infinites sister ship called",
    answers: [
        {text: "The Pillar of Autumn"},
        {text: "Spirt of Fire"},
        {text: "Eternity"},
...
{
    question: "What Installation did Black team die on",
    answers: [
        {text: "Installation 06"},
        {text: "Installation 03"},
        {text: "Installation 05"},
        {text: "Installation 02"}
    ],
    correctAnswer: "Installation 03"
},
{
    question: "What was Blue teams first mission together",
    answers: [
        {text: "To take over Installation 04"},
        {text: "To Assassinate the Prophet of Mercy"},
        {text: "To Infiltrate Unrelenting"},
        {text: "To take down a super Scarab on Reach"}
    ],
    correctAnswer: "To Infiltrate Unrelenting"
},
{
    question: "Which member of Blue died during their first mission",
    answers: [
        {text: "John-117"},
        {text: "linda-058"},
        {text: "Kelly-087"},
...
{
    question: "Who did Tartarus challange and kill to move up the ranks",
    answers: [
        {text: "Avitus"},
        {text: "Maccabeus"},
        {text: "Escharum"},
