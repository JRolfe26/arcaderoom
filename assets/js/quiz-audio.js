...
//Variables
const questionRightSound = new Audio("assets/audio/right-sound.mp3");
const questionWrongSound = new Audio("assets/audio/wrong-sound.wav");
const buttonClick = new Audio("assets/audio/button-click.mp3");
const backgroundMusic = new Audio("assets/audio/background-music.mp3");
const timerSounds = new Audio("assets/audio/timer-clicks.mp3");
